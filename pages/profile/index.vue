...
const tabs = [
  { id: 'profile', name: 'Hồ sơ', icon: 'profile' },
  { id: 'overview', name: 'Tổng quan', icon: 'overview' },
  { id: 'schedule', name: 'Lịch trình', icon: 'schedule' },
  { id: 'wallet', name: 'Doanh thu', icon: 'wallet' },
];
