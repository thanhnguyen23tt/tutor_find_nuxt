...
// import NotificationPreview from "../common/NotificationPreview.vue";
...
// onMounted(async () => {
//     fetchUnreadData();
//     // Fetch unread data every 60 seconds
...
//     <NotificationPreview
//         :show="showNotificationPreview && !hiddenNotificationPreview"
//         :unread-data="unreadData"
//         @close="closeNotificationPreview"
//     />

//     <!-- Global Notification Button -->
//     <div class="notification-hero-button" v-if="!hiddenNotificationPreview && isAuthenticated" @click="toggleNotificationPreview">
//         <div class="notification-btn-content">
//             <div class="notification-btn-icon">
//                 <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5 5v-5zM11 17H7l4 4v-4zM13 3a9 9 0 919 9v4l2 2v1H0v-1l2-2V12A9 9 0 0113 3z"/>
//                 </svg>
//             </div>
...
//             </div>
//         </div>
//         <div v-if="totalUnreadCount > 0" class="notification-btn-badge">{{ totalUnreadCount > 99 ? '99+' : totalUnreadCount }}</div>
//     </div>

//     <layout class="layout-main" v-if="!route.meta.noLayout && !isLoading">
//         <Header />
