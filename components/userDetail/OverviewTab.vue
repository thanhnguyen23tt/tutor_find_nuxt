    ...
    <div class="content-section">
        ...
        <div class="content-card pricing-main-card" v-if="hasSubjects">
            ...
            <div class="price-cards" v-if="currentLevels.length > 0">
                <div 
                    class="price-card-modern" 
                    :class="{ 'highlight': level.highlight }" 
                ...
                >
                    <div class="price-card-header">
                        <div class="level-icon-wrapper">
                            <img 
                                class="icon-lg" 
                                :src="level.education_level_image" 
                                :alt="level.education_level"
                                loading="lazy"
                            >
                        </div>
                    ...
                    <div class="price-card-action">
                        <button 
                            class="btn-lg w-100" 
                            :class="level.highlight ? 'btn-primary' : 'btn-secondary'"
                        >
                            <svg class="icon-md" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="time-list">
                            <template v-if="getDaySlots(day.id).length > 0">
                                <div
                                    ...
                                    :key="`desktop-slot-${day.id}-${slot.id}`"
                                    class="time-item"
                                    :class="{
                ...
                <div class="mobile-time-section">
                    ...
                    <div class="mobile-time-list" v-if="selectedDaySlots.length > 0">
                        <button
                            ...
                            :key="`mobile-slot-${selectedMobileDayId}-${slot.id}`"
                    ...
                    <div v-else class="mobile-empty">
                        <div class="empty-content">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M4.5 16.5c-1.5 1.26-2.01429 5.00357-2.01429 5.00357s3.75429-0.50357 5.01429-2.00357c0.71-0.840.7-2.13-0.09-2.91a2.18 2.18 0 0 0-2.91-0.09z"></path>
